(function(f) {
    ...
    return function e(t, n, r) {
        ...
        1: [ function(_dereq_, module, exports) {
            ...
            var _es6Promise = _dereq_('es6-promise'), _es6Promise2 = _interopRequireDefault(_es6Promise), _browser = _dereq_('./browser'), _browser2 = _interopRequireDefault(_browser);
            _es6Promise2['default'].polyfill(), exports['default'] = _browser2['default'], module.exports = exports['default'];
        }, {
            './browser': 2,
            'es6-promise': 28
        } ],
